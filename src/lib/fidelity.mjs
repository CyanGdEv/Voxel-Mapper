...
export function deriveSurfaceStyle(feature, options = {}) {
  ...
  const taggedMaterial = firstValue(tags.surface, tags.material, tags["surface:material"], tags.paving);
...
function deriveTreeEvidence(feature, sources, options) {
  ...
  const crownDiameter = parseLength(firstValue(
  ...
  return {
    ...
    crownSource: crownDiameter === null ? null : "tagged-crown-diameter",
    spacingM,
...
function summarizeSurfaceEvidence(features, options = {}) {
  ...
  return {
    ...
    materialCoverage: ratio(covered((feature) => Boolean(feature.surfaceStyle?.material)), total),
